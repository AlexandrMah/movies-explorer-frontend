  ...
  return (
    <nav className="navi">
      ...
      <div className="navi__user">
        {location.pathname === "/" && <button onClick={navigateToSignUp} type="button" className="navi__element navi__element_text">Регистрация</button>}

        {location.pathname === "/" && <button onClick={navigateToSignIn} type="button" className="navi__element navi__element_text navi__element_btn">Войти</button>}
